        ...
        Tool(
            ...
            inputSchema: .object([
                ...
                "properties": .object([
                    ...
                    "source": .object([
                        "type": .string("string"),
                        "description": .string("Source branch to merge (for merge_analysis)"),
                    ]),
                    "target": .object([
                        "type": .string("string"),
                    ...
                    "force": .object([
                        "type": .string("boolean"),
                        "description": .string("Force push (for push), force delete with -D (for branch_delete), force remove (for worktree_remove)"),
                    ]),
                    "setUpstream": .object([
                        "type": .string("boolean"),
